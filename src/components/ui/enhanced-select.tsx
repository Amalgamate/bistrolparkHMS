...
>(({ className, children, size = 'lg', variant = 'clinical', ...props }, ref) => {
  const sizeClasses = {
    sm: 'h-8 px-3 text-sm',
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex w-full items-center justify-between rounded-md border transition-colors focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
        sizeClasses[size],
