...
interface ClinicalStylePatientRegistrationProps {
  onClose?: () => void;
  onSave?: (patientData: any) => void;
}

const ClinicalStylePatientRegistration: React.FC<ClinicalStylePatientRegistrationProps> = ({
  onClose,
  onSave
}) => {
                ...
                <div className="text-center py-8">
                  ...
                  <div className="bg-blue-50 p-6 rounded-lg inline-block mb-6">
                    <div className="text-center">
                      ...
                      <div className="text-lg font-bold">{patientId}</div>
                      <div className="text-sm text-gray-600 mt-2">{patientName}</div>
                    </div>
                  </div>
...
export default ClinicalStylePatientRegistration;