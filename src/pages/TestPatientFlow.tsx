...
import { TEST_USERS, TEST_PATIENT, TEST_VITALS, TEST_LAB_TESTS } from '../utils/testHelpers';
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Front Office:</strong> {TEST_USERS.FRONT_OFFICE.email} / {TEST_USERS.FRONT_OFFICE.password}
                  </li>
                  <li>
                    <strong>Nurse:</strong> {TEST_USERS.NURSE.email} / {TEST_USERS.NURSE.password}
                  </li>
                  <li>
                    <strong>Doctor:</strong> {TEST_USERS.DOCTOR.email} / {TEST_USERS.DOCTOR.password}
                  </li>
                  <li>
                    <strong>Lab Technician:</strong> {TEST_USERS.LAB.email} / {TEST_USERS.LAB.password}
                  </li>
                </ul>
